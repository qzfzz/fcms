...
class FcmsInstall extends Model
{
    ...
    */
    public function insertInfo( $n, $link, $dbName, $masterUsername, $masterPassword, $masterEmail )
    {
        ...
        $sql = "REPLACE INTO `".$dbName."`.`fcms_pri_users` ( `id`, `name`,`loginname`,`pwd`,`email`,`groupid`,`status`) 
                VALUES ( " . SystemEnums::SUPER_ADMIN_ID . ", '".$masterUsername."','".$masterUsername."','".$masterPassword."','".$masterEmail."',1,0);";
