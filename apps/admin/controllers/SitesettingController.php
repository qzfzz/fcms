...
class SitesettingController extends AdminBaseController{
    ...
    {
    	$where = array(
    		'columns'	=> 'id,addtime,uptime,delsign,name,domain,logo,seokey,seodescr,copyright,static_code,is_main',
    ...
    public function siteListAction()
    {
    	...
    	$builder = $this->modelsManager->createBuilder()
    				->columns( 'id,addtime,uptime,delsign,name,domain,logo,seokey,seodescr,copyright,static_code,is_main' )
			    	->from( 'apps\admin\models\SiteSetting' )
			    	->where( 'delsign=' . SystemEnums::DELSIGN_NO . ' ORDER BY is_main ASC' );
