    ...
    <body class="wrap">
        ...
        <div class="tab-content">
            <div role="tabpannel" class="tab-pane active" id="adAdd" style="padding-top:20px;">
                <form class="form-horizontal" action="/admin/staticcache/saveColumn" method="post" onsubmit="return checkFormVals();">
                    ...
                    <div class="form-group" style="margin-top: 30px;">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <button type="button" class="btn btn-default btn-sm" onclick="javascript:location.href='/admin/staticcache/column'" style="width:70px;">取消</button>
                        </div>
                    </div>
                </form>
