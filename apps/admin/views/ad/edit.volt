            ...
            <div role="tabpannel" class="tab-pane active" id="adEdit" style="padding-top:20px;">
                <form class="form-horizontal">
                    ...
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control form_datetime" type="text" id="begin_time" name="begin_time" placeholder="请输开始时间" value="<?php echo $this->escaper->escapeHtmlAttr( date( 'Y-m-d H:i:s',
                $ad[ 'begin_time' ] ) ) ?>" required="required"/>
                    ...
                    <div class="form-group has-feedback text-right">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control form_datetime" type="text" id="end_time" name="end_time" placeholder="请输结束时间" value="<?php echo $this->escaper->escapeHtmlAttr( date( 'Y-m-d H:i:s',
...
$( function(){
    ...
    $( '#adUpdate' ).click( function(){
		...
		var aid = {{ ad[ 'id' ] | escape_attr }};
        if( !$( 'form span' ).hasClass( 'glyphicon-remove' ) ){ //数据正确可以提交表单了
			var data = $( 'form' ).serialize();
			data += '&adId='+aid+'&key='+key+'&token='+token;
