    ...
    <body>
            ...
            <div class="col-xs-offset-4 col-xs-4 ">
                 <div class="panel panel-danger">
                     ...
                     <div class="panel-footer text-center">
                            ...
                            {% else %}
                            <a class='btn btn-sm btn-default' id="url" href="/admin/index/home"> 返回首页</a>
                            {% endif %}
                     </div>
                    </div>
            </div>
        ...
        <div class="self_main">
        	<div class="self_content">
        		...
        		<div>
					<i class="time">5</i> <span>秒后</span>
					<a href="/admin/index/fcmshome" id='url'> 返回首页</a>
				</div>
        ...
        <script> 
        	$( document ).ready( function(){
        		$( '.bsc_nav_position', parent.document ).html( '<span class="glyphicon glyphicon-home"></span><span class="bsc_space"></span>首页' ); 
        	} );
            decTime();
            function decTime()
            {
