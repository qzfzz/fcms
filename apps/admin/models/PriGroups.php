...
class PriGroups extends Model
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany( 'id', 'apps\admin\models\PriUsers', 'groupid', array( 'alias' => 'priGroupsUsers' ) );
    }
    ...
    public function getGroup()
    {
        $phql = 'select g.id as group_id, g.name as group_name, r.name as role_name from apps\admin\models\PriGroups as g ' .
                ...
                'where g.id !='. SystemEnums::SUPER_ADMIN_ID .' and g.delsign=' . SystemEnums::DELSIGN_NO . ' and gr.delsign=' . SystemEnums::DELSIGN_NO;
